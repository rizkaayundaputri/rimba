...
const GroupAccessController = require('./controllers/groupAccess')
app.use(cors())
...
app.get('/module/:id', isStaff, ModuleController.getModuleById)
...
app.get('/group-access-module/:id', isStaff, groupAccessModuleController.getGroupAccessModuleById)
...
app.get('/group-access',isStaff,GroupAccessController.getData)
